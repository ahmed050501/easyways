...
function Div2() {
  ...
  <div className='w-[40%] h-[30rem] bg-blue-400'>
    <p className='text-2xl text-blue-50 ml-4 italic hover:not-italic'>Condition for book scooty</p>
    <p className='ml-2 text-lg italic hover:not-italic'>1. There is only person book one bike</p>
    <p className='ml-2  text-lg italic hover:not-italic'> 2. There is only one  or two bags but <br/>weight no over 20kg</p>
   ...
   <div className='flex w-[10rem] h-[4rem] rounded-full ml-4 bg-black'>
      ...
      <div className='w-[60%] h-[60rem] bg-orange-300 float-right'>
        <img src={download} className="w-full h-[60%]"/> 
        <img src={img} className="w-full h-[40%]"/>
      </div>
      </div>
      <div className='w-[40%] h-[30rem] mt-[-30rem] bg-blue-400'>
    <p className='text-2xl text-blue-50 ml-4 italic hover:not-italic'>Condition for book Bike</p>
    <p className='ml-2 text-lg italic hover:not-italic'>1. There is only person book one bike</p>
    <p className='ml-2  text-lg italic hover:not-italic'> 2. There is only one  or two bags but <br/>weight no over 30kg</p>
    <p className='ml-2  text-lg italic hover:not-italic'>3. Face mask compulsory</p>
    <input type = "text"
          name = "city"
          placeholder = "City"
   ...
   <div className='flex w-[10rem] h-[4rem] rounded-full ml-4 bg-black'>
       <button className='text-white'>  <Link to="/openmodel" className='pr-2'>
       BOOK-Bike
            </Link></button>
       <img src='https://cdn-icons-png.flaticon.com/512/5511/5511414.png' className=' w-[80px] h-[60px] '/>  
   </div>
